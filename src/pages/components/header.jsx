      ...
      <div className="d-flex flex-column sidepanel-inner">
        ...
        <nav id="app-nav-main" className="flex-grow-1 app-nav app-nav-main">
          <ul className="app-menu list-unstyled accordion" id="menu-accordion">
            ...
            <li className="nav-item">
              {/*//Bootstrap Icons: https://icons.getbootstrap.com/ */}
              <a className="nav-link" href="/screens/category">
                <span className="nav-icon">
                  <svg
                    width="1em"
                    height="1em"
            ...
            <li className="nav-item">
              {/*//Bootstrap Icons: https://icons.getbootstrap.com/ */}
              <a className="nav-link" href="/screens/subcategory">
                <span className="nav-icon">
                  <svg
                    width="1em"
                    height="1em"
            ...
            <li className="nav-item">
              {/*//Bootstrap Icons: https://icons.getbootstrap.com/ */}
              <a className="nav-link" href="/screens/product">
                <span className="nav-icon">
                  <svg
                    width="1em"
                    height="1em"
            ...
            <li className="nav-item">
              {/*//Bootstrap Icons: https://icons.getbootstrap.com/ */}
              <a className="nav-link" href="/screens/users">
                <span className="nav-icon">
                  <svg
                    width="1em"
                    height="1em"
        ...
        <div className="app-sidepanel-footer">
          <nav className="app-nav app-nav-footer">
            <ul className="app-menu list-unstyled footer-menu">
              <li className="nav-item">
                {/*//Bootstrap Icons: https://icons.getbootstrap.com/ */}
                <a className="nav-link" href="/screens/settings">
                  <span className="nav-icon">
                    <svg
                      width="1em"
                      height="1em"
