...
import { addSubCategory, getSubCategories, deleteSubCategory, updateSubCategory } from "@/services/product/subcategory-service";
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (selectedSubCategory) {
                ...
                const updatedSubCategory = new SubCategoryModel(
            ...
            <div className="mx-auto p-4 container">
                            ...
                            <div className="inline-block relative align-bottom bg-white shadow-xl sm:my-8 px-4 sm:p-6 pt-5 pb-4 rounded-lg sm:w-full sm:max-w-lg text-left transform transition-all overflow-hidden sm:align-middle">
                                ...
                                <div className="mb-4">
                                    <h3 className="font-medium text-gray-900 text-lg leading-6">
                                        {selectedSubCategory ? 'Edit Category' : 'Add New Category'}
                                    </h3>
                                    <p className="mt-1 text-gray-500 text-sm">
                                        {selectedSubCategory ? 'Edit the category details' : 'Fill in the details to create a new category'}
                                    </p>
                                </div>

                                <form onSubmit={handleSubmit} className="space-y-5">
                                    <div>
                                        <label htmlFor="categoryId" className="block font-medium text-gray-700 text-sm">Category</label>
                                        <div className="mt-1">
                                            <select
                                                name="categoryId"
                                                id="categoryId"
                                        ...
                                        >
                                            {isSubmitting ? (
                                                <>
                                                    ...
                                                    {selectedSubCategory ? 'Updating...' : 'Adding...'}
                                                </>
                ...
                {isLoading ? (
                        ...
                        <table className="divide-y divide-gray-200 min-w-full">
                            <thead className="bg-gray-50">
                                <tr>
                                    ...
                                    <th scope="col" className="px-6 py-3 font-medium text-gray-500 text-left text-xs uppercase tracking-wider">Category</th>
                                    ...
                                    return (
                                        <tr key={subcategory.id}>
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="line-clamp-2 text-gray-500 text-sm">{subcategory.description}</div>
                                            </td>
                                            <td className="px-6 py-4 whitespace-nowrap">
                                                <div className="text-gray-900 text-sm">{parentCategory?.name || 'Unknown Category'}</div>
                                            </td>
                    ...
                    <div className="flex flex-col justify-center items-center bg-gray-50 rounded-lg min-h-[400px]">
                        ...
                        <h3 className="mb-1 font-medium text-gray-900 text-xl">No Subcategories Yet</h3>
                        <p className="text-gray-500">Get started by adding your first subcategory</p>
                    </div>
                )}
            </div>
        </div>
